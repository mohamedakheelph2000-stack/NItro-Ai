...
function showWakeupBanner(text) {
    ...
    else textEl.textContent = 'Backend is waking up — this can take up to 30 s on the free plan…';
...
async function sendMessage() {
    ...
    try {
        ...
        removeTypingIndicator(typingId);
        showToast('Message failed — click Retry below the error.', 'error');
...
async function checkConnection() {
    try {
        ...
        // Short timeout for health check — if backend is sleeping the banner will show
